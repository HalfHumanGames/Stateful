...
namespace TicTacToeExample {
	...
	public class TicTacToe : StateMachine<StateId, ParamId> {
		...
		public TicTacToe() {
			// This set up is kinda ugly.. maybe make a method Create that returns the state machine'
			// and use it in a factory instead
			Configure(
				...
				Builder. // Builder just creates a new StateMachineBuilder
